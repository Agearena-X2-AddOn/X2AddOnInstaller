...
public class DRSFile
{
	...
	public void WriteData()
	{
		...
		// Erstes Tabellen-Offset ausrechnen
		// Hilft bei der Geschwindigkeitserhöhung beim TABELLEN-Prozess
		...
		// Erstes Datei-Offset ausrechnen
		// Hilft bei der Geschwindigkeitserhöhung beim DATEIEN-Prozess
	...
	/// </summary>
	/// <param name="ZielDatei">Die Datei, in die die Data geschrieben werden sollen.</param>
	/// <remarks></remarks>
	public void WriteData(string ZielDatei)
	{
		// Data in Puffer schreiben
		WriteData();

		// Puffer in Datei schreiben
		_buffer.Save(ZielDatei);
	...
	/// <summary>
	/// Schreibt einen String der gegebenen Länge.
	/// Falls der String kürzer ist, wird der Rest mit 0-Bytes aufgefüllt.
	/// </summary>
